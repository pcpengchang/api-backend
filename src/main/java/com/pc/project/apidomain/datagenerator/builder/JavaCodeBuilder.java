package com.pc.project.apidomain.datagenerator.builder;

import cn.hutool.core.util.StrUtil;
import com.pc.project.apidomain.datagenerator.dto.JavaEntityGenerateDTO;
import com.pc.project.apidomain.datagenerator.dto.JavaObjectGenerateDTO;
...
import com.pc.project.apidomain.datagenerator.dto.JavaEntityGenerateDTO.FieldDTO;
...
public class JavaCodeBuilder {
     ...
     */
    // @SneakyThrows
    public static String buildJavaEntityCode(TableSchemaRequest tableSchema) throws IOException, TemplateException {
        // 传递参数
        ...
        for (TableSchemaRequest.Field field : tableSchema.getFieldList()) {
     ...
     */
    //@SneakyThrows
    public static String buildJavaObjectCode(TableSchemaRequest tableSchema, List<Map<String, Object>> dataList) throws IOException, TemplateException {
        // 模板引擎真好用
        ...
        List<TableSchemaRequest.Field> fieldList = tableSchema.getFieldList();
        ...
        for (TableSchemaRequest.Field field : fieldList) {
     ...
     * @return
     */
    public static String getValueStr(TableSchemaRequest.Field field, Object value) {
