...
import com.pc.project.model.enums.PayChannelEnum;
import com.pc.project.pay.PayCallbackCommand;
    ...
    public void tradePagePay(HttpServletResponse httpResponse) {
        ...
        try {
            ...
            if (!response.isSuccess()) {
                throw new BusinessException(ErrorCode.PARAMS_ERROR, "调用支付宝发起支付异常");
            }
