...
import com.pc.project.model.vo.GenerateVO;
import com.pc.project.utils.GeneratorFacade;
...
public class SqlController {
    ...
    public BaseResponse<GenerateVO> generateBySchema(@RequestBody TableSchema tableSchema) throws TemplateException, IOException {
        // 智能导入（多字段填充构建）
